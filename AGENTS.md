...
- **対応**:
  ...
  3. ミドルウェアと `withSanitizedLimit()` で `ctx.state.commentsLimit` を共有し、後続のレスポンス正規化が同じ値を利用できるよう統合した。【F:cms/src/middlewares/comments-limit-sanitizer/index.js†L1-L22】【F:cms/src/extensions/comments/strapi-server.js†L31-L63】
