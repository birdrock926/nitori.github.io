...
export default factories.createCoreController('api::comment.comment', ({ strapi }) => {
  ...
  async submit(ctx) {
    ...
    const publishSetting = (process.env.COMMENTS_AUTO_PUBLISH || 'smart').toLowerCase();
    const forceManualReview = publishSetting === 'manual';
    const allowAutoPublish = publishSetting === 'always' || publishSetting === 'smart';
    const shouldPublishNow = allowAutoPublish && !forceManualReview && !requiresReview;
